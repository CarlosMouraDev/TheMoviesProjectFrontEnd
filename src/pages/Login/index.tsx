...
export default function Login() {
  ...
  return (
    <div className='min-h-[86vh] flex items-center justify-center bg-[#0f172a] px-6'>
      <div className='w-full max-w-md bg-[#1e293b] p-8 rounded-2xl shadow-lg'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
          ...
          <button
            type='submit'
            disabled={loading}
            className='w-full mt-2 py-2 rounded-lg bg-[#6366f1] text-[#f1f5f9] font-semibold hover:bg-[#4f46e5] transition disabled:opacity-50 cursor-pointer'
          >
